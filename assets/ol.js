 ...
 * Original file: /npm/openlayers@4.6.5/dist/ol.js
 *
...
(function (root, factory) {
  ...
  function ha(a) {
    this.message =
      'Assertion failed. See https://openlayers.org/en/v4.6.5/doc/errors/#' + a + ' for details.';
    this.code = a;
  ...
  function Fa(a, b, c) {
    return c
      ? ((c[0] = a[0] - b), (c[1] = a[1] - b), (c[2] = a[2] + b), (c[3] = a[3] + b), c)
  ...
  function Ua(a, b, c) {
    var d;
    return (d = b.call(c, Wa(a))) || (d = b.call(c, Ya(a))) || (d = b.call(c, Za(a)))
      ? d
      : (d = b.call(c, $a(a)))
      ? d
      : !1;
...
*/
  ...
  function Pb(a, b) {
    ...
    if (!e) {
      ...
      if ('function' == typeof f) {
        ...
        void 0 !== g &&
          void 0 !== h &&
          (g === h ? Qb([b, a]) : ((e = f(d, c)), Vb(b, a, e.forward, e.inverse)), (e = Lb(c, d)));
      }
    }
    e || (e = $b);
    return e;
  ...
  function uc(a, b, c, d, e) {
    ...
    for (; g >= a.minZoom; ) {
      2 === a.l
        ? ((h = Math.floor(h / 2)), (l = Math.floor(l / 2)), (b = ka(h, h, l, l, d)))
        : (b = tc(a, f, g, d));
  ...
  k.J = function (a, b, c) {
    if (Array.isArray(a)) for (var d = 0, e = a.length; d < e; ++d) Mc(this, a[d], b, c);
    else Mc(this, a, b, c);
  };
  function Vc(a) {
    Uc.call(this);
  ...
  k.Nm = function (a) {
    if (!Dd(this, a)) {
      ...
      b &&
        b.button === a.button &&
        ((b = Ed(a)), Gd(this.b, 'pointerup', b, a), delete this.a[(1).toString()]);
    }
  };
  k.Mm = function (a) {
    if (!Dd(this, a)) {
  ...
  function me(a, b, c) {
    for (var d = 0, e = !1, f, g, h; a.j < b && d < c && 0 < a.b.length; )
      (g = he(a)[0]),
        (h = g.lb()),
        (f = g.getState()),
        5 === f ? (e = !0) : 0 !== f || h in a.f || ((a.f[h] = !0), ++a.j, ++d, g.load());
    0 === d && e && a.v();
  }
  function ne(a) {
    return function (b) {
  ...
  function qe(a, b, c) {
    return function (d, e, f) {
      if (void 0 !== d)
        return (
          (d = Math.max(Math.floor(Math.log(b / d) / Math.log(a) + (-f / 2 + 0.5)) + e, 0)),
  ...
  k.Nb = function (a, b, c, d) {
    ...
    this.c != this.g &&
      ((this.j = Math.sqrt(pf(this.A, 0, this.A.length, this.a, 0))), (this.c = this.g));
  ...
  k.na = function (a, b) {
    a
      ? (lf(this, b, a, 0), this.A || (this.A = []), (this.A.length = vf(this.A, a)), this.u())
      : this.ba('XY', null);
  };
  k.ba = function (a, b) {
    kf(this, a, b);
  ...
  function If(a, b, c, d, e, f, g) {
    ...
    for (l = r.length; h < l; ++h)
      (n = r[h]),
        (z = Math.abs(n - m)),
        z > v && ((m = (m + n) / 2), Hf(a, b, c, d, m, q) && ((u = m), (v = z))),
        (m = n);
    isNaN(u) && (u = e[f]);
  ...
  function Kf(a, b, c, d, e) {
    var f = Ra(Da(), a, b, c, d);
    return hb(e, f)
      ? La(e, f) || (f[0] >= e[0] && f[2] <= e[2]) || (f[1] >= e[1] && f[3] <= e[3])
        ? !0
  ...
  k.Xb = function () {
    if (this.T != this.g) {
      ...
      Nf(a, this.c, this.a)
        ? (this.j = a)
        : ((this.j = a.slice()), (this.j.length = Of(this.j, 0, this.c, this.a)));
      this.T = this.g;
    }
    return this.j;
  };
  ...
  function Vf(a, b) {
    ...
    (void 0 !== b.enableRotation ? b.enableRotation : 1)
      ? ((d = b.constrainRotation),
        (d = void 0 === d || !0 === d ? we() : !1 === d ? se : 'number' === typeof d ? ue(d) : se))
      : (d = re);
  ...
  k.animate = function (a) {
    ...
    if (ag(this)) {
      for (
        var d = Date.now(), e = this.xa().slice(), f = this.Pa(), g = this.Sa(), h = [], l = 0;
        l < b;
        ++l
      ) {
        var m = arguments[l],
        ...
        void 0 !== m.zoom
          ? ((n.ke = f), (n.kd = this.constrainResolution(this.a, m.zoom - this.s, 0)), (f = n.kd))
      ...
      for (var a = Date.now(), b = !1, c = this.c.length - 1; 0 <= c; --c) {
        for (var d = this.c[c], e = !0, f = 0, g = d.length; f < g; ++f) {
          ...
          if (!h.complete) {
            ...
            void 0 !== h.Df &&
              void 0 !== h.ne &&
              ((b = 1 === b ? wa(h.ne + Math.PI, 2 * Math.PI) - Math.PI : h.Df + b * (h.ne - h.Df)),
  ...
  k.Uf = function (a, b) {
    ...
    void 0 !== b.duration
      ? this.animate({ resolution: c, center: a, duration: b.duration, easing: b.easing }, e)
  ...
  function zg(a) {
    ...
    c.appendChild(d);
    vg.call(this, { element: c, render: a.render ? a.render : Ag, target: a.target });
    this.B = [];
    this.C = !0;
    this.O = {};
  }
  ...
  function Ag(a) {
    if ((a = a.frameState)) {
      for (
        var b = {}, c = [], d = a.layerStatesArray, e = a.viewState.resolution, f = 0, g = d.length;
        f < g;
        ++f
      ) {
        var h = d[f];
      ...
      if (!jc(c, this.B)) {
        ...
        0 === c.length && 0 < this.B.length
          ...
          : 0 === this.B.length && 0 < c.length && this.element.classList.remove('ol-logo-only');
        ...
        for (var n in a)
          if (
            ((d = a[n]), d instanceof HTMLElement && (this.l.appendChild(d), (c[n] = d)), !(n in c))
          ) {
            var p = new Image();
            p.src = n;
            '' === d
              ? (b = p)
              : ((b = document.createElement('a')), (b.href = d), b.appendChild(p));
  ...
  k.Dn = function (a) {
    this.j !== a &&
      ((this.j = a), this.element.classList.toggle('ol-uncollapsible'), !a && this.c && Bg(this));
  };
  k.Cn = function (a) {
  ...
  Cg.prototype.D = function (a) {
    ...
    void 0 !== this.l
      ...
      : (a = this.a.aa()) &&
        void 0 !== a.Sa() &&
        (0 < this.v ? a.animate({ rotation: 0, duration: this.v, easing: Oe }) : a.ce(0));
  };
  function Dg(a) {
    if ((a = a.frameState)) {
  ...
  Eg.prototype.j = function (a, b) {
    ...
    if ((b = this.a.aa())) {
      ...
      c &&
        ...
        0 < this.c
          ? (b.Ac() && b.rd(), b.animate({ resolution: a, duration: this.c, easing: Oe }))
          : b.gd(a));
    }
  };
  function Fg(a) {
  ...
  function Ih(a) {
    ...
    if (this.l === Ph) {
      ...
      0 < g
        ? b.animate({ resolution: e, easing: Oe, anchor: this.a, duration: 500 })
  ...
  function Th(a) {
    ...
    void 0 !== this.j &&
      ((b = c - this.j), (this.s += b), !this.a && Math.abs(this.s) > this.C && (this.a = !0));
    this.j = c;
    a = a.map;
    c = a.aa();
    if (c.l.rotation !== re) {
  ...
  function Zh(a) {
    ...
    (void 0 !== a.pinchZoom ? a.pinchZoom : 1) &&
      b.push(new Vh({ constrainResolution: a.constrainResolution, duration: a.zoomDuration }));
    if (void 0 !== a.keyboard ? a.keyboard : 1)
      b.push(new Dh()), b.push(new Fh({ delta: a.zoomDelta, duration: a.zoomDuration }));
    (void 0 !== a.mouseWheelZoom ? a.mouseWheelZoom : 1) &&
      b.push(new Hh({ constrainResolution: a.constrainResolution, duration: a.zoomDuration }));
      ...
      return function (d) {
        if ((d = wg(d)))
          for (var f = 0, g = d.length; f < g; ++f) {
            var m = d[f];
            m in c ||
              ((c[m] = 60), a(m) || ((c[m] = 0), void 0 === e && (e = window.setInterval(b, 32))));
          }
      };
    })();
  function mi() {
    ...
    return function (c) {
      if (a.hasOwnProperty(c)) var d = a[c];
        ...
        if (ti.exec(d)) {
          ...
          1 == f &&
            ((e = (e << 4) + e), (h = (h << 4) + h), (l = (l << 4) + l), g && (d = (d << 4) + d));
          f = [e, h, l, d / 255];
        } else
          0 == d.indexOf('rgba(')
            ? ((d = d.slice(5, -1).split(',').map(Number)), (f = yi(d)))
            : 0 == d.indexOf('rgb(')
            ? ((d = d.slice(4, -1).split(',').map(Number)), d.push(1), (f = yi(d)))
            : oa(!1, 14);
        d = f;
        a[c] = d;
        ++b;
    ...
    if (a.qa && '' !== a.ta) {
      ...
      h
        ...
        : ((g.font = f.font),
          ...
          (a.Wa = { font: f.font, textAlign: l, textBaseline: f.textBaseline }));
  ...
  function Fi(a, b) {
    ...
    d
      ? (d.lineCap != b.lineCap && (d.lineCap = c.lineCap = b.lineCap),
        od &&
          (jc(d.lineDash, b.lineDash) || c.setLineDash((d.lineDash = b.lineDash)),
        ...
        d.strokeStyle != b.strokeStyle && (d.strokeStyle = c.strokeStyle = b.strokeStyle))
      : ((c.lineCap = b.lineCap),
        od && (c.setLineDash(b.lineDash), (c.lineDashOffset = b.lineDashOffset)),
  ...
  aj.prototype.wa = function (a, b, c, d, e) {
    ...
    return f
      .ha()
      .wa(a, b.viewState.resolution, b.viewState.rotation, c, b.skippedFeatureUids, function (a) {
        return d.call(e, a, f);
      });
  };
  ...
  k.wa = function (a, b, c, d, e, f, g) {
    ...
    for (q = p.length - 1; 0 <= q; --q) {
      ...
      if (
        yg(u, n) &&
        f.call(g, r) &&
        ((u = ij(this, r)), r.ha() && (l = u.wa(r.ha().D ? m : a, b, c, h, e)), l)
      )
        return l;
    }
  };
      ...
      if ((xa = this.context))
        (ia = l.Zd(p, c, f)),
          ...
          la.width != ca || la.height != ia
            ...
            : (this.c && !Sa(z, this.c) && xa.clearRect(0, 0, ca, ia), (r = this.C));
      this.f.length = 0;
    ...
    function z(a, b, c, d, e) {
      for (var f = [b, c], g; f.length; )
        (c = f.pop()),
          (b = f.pop()),
          c - b <= d ||
            ((g = b + Math.ceil((c - b) / d / 2) * d), A(a, g, b, c, e), f.push(b, g, g, c));
    }
    var A = b;
    A.default = b;
    f.prototype = {
      ...
      load: function (a) {
        ...
        this.data.children.length
          ? this.data.height === a.height
            ? this.yh(this.data, a)
            : (this.data.height < a.height && ((b = this.data), (this.data = a), (a = b)),
  ...
  function zj(a, b, c, d, e, f, g, h, l, m, n, p, q, r, u, v, z, A, E) {
    ...
    if (h) {
      if (q || 1 != h[4])
        Ta(h, v),
          (a = q ? [b, z ? z.slice(0) : null, m, e, n, p, u, l, c, d, r] : null) &&
            S &&
      ...
      if (1 == d || d == b.length - 5) {
        ...
        if (!a.ra.Ok(c))
          for (a.ra.Ca(c), c = 5, d = b.length; c < d; ++c) {
            var e = b[c];
            e &&
              (11 < e.length && xj(a, e[0], e[13], e[14], e[15], e[16], e[11], e[12]),
              si.apply(void 0, e));
          }
        b.length = 5;
        Oa(b);
  ...
  function Hj(a, b, c, d, e, f, g) {
    ...
    for (
      var l = !nb(d),
        ...
        xa = a.Ub,
        Va = a.$,
        ic = { context: b, pixelRatio: a.pixelRatio, resolution: a.resolution, rotation: Va },
            ...
            a: {
              ...
              for (
                ...
                var Ep = Ju / Oi,
                  ...
                  Gp = ya(Mh, Pg, Ep);
                Ni == Rg
                  ? (Kh && ((Xf[0] = Fp), (Xf[1] = Gp), (Xf[2] = Qg / 2)), (Xf[4] = Yf))
                  : ((Yf = Qk),
                    (Pk = Qg),
                    (Xf = [Fp, Gp, Qg / 2, Rg, Yf]),
            ...
            for (
              ...
              void 0 !== r &&
                ...
                void 0 !== v &&
                  ...
                  u > e.maxAngle && (S > E && ((E = S), (n = Ia), (A = m)), (S = 0), (Ia = m - h))),
                (z = g),
                (v = r),
                (u = q));
              r = ta;
  ...
  Sj.prototype.Y = function (a, b, c, d) {
    ...
    if (!ii.a.hasOwnProperty(e)) {
      ...
      f = 0.5 - m;
      g = (m * u.width) / l + f * b;
      if (d) for (d = 0; d < n; ++d) r.strokeText(a[d], g + f * p[d], 0.5 * (b + q) + d * q);
      if (c) for (d = 0; d < n; ++d) r.fillText(a[d], g + f * p[d], 0.5 * (b + q) + d * q);
    }
    return ii.get(e);
  };
  function Uj(a, b, c, d) {
  ...
  Sj.prototype.nb = function (a, b) {
    ...
    if (a) {
      ...
      this.B = void 0 === h ? 0 : h;
      this.V = d
        ? ('string' == typeof d.strokeStyle ? d.strokeStyle : x(d.strokeStyle)) +
          d.lineCap +
          d.lineDashOffset +
          '|' +
          d.lineWidth +
      ...
      for (var Ia = 0, ta = m.a.length; Ia < ta; ++Ia) {
        ...
        if (3 != la.getState()) {
          ...
          for (var Zb, Le = 0, Uf = Z.length; Le < Uf; ++Le)
            if (
              ((Zb = Z[Le]),
              ic && ('tile-pixels' == Va.a && (Va.Sj(ca), Va.Si(la.G())), Zb.U().mb(Va, q)),
              !xa || hb(xa, Zb.U().G()))
            ) {
              var Id = void 0,
                te = Zb.ib();
  ...
  k.pf = function (a, b, c) {
    ...
    for (var r = [], u = l.length - 1; 0 <= u; --u) {
      ...
      if (5 != v.getState())
        for (
          var z = v.ya, A = f.Ma(z)[0] - f.Ma(v.l)[0], E = void 0, S = 0, Ia = v.a.length;
          S < Ia;
          ++S
        ) {
          var ta = v.c[v.a[S]];
  ...
  k.Jh = function (a, b, c, d) {
    ...
    this.Ya &&
      ...
      (b.lineWidth = a.Wj),
      a.lineDash && (b.setLineDash(a.lineDash), (b.lineDashOffset = a.lineDashOffset)),
      (b.lineCap = a.lineCap),
  ...
  k.fn = function () {
    if (rd) {
      ...
      a && void 0 === this.c
        ...
        : a || void 0 === this.c || (navigator.geolocation.clearWatch(this.c), (this.c = void 0));
    }
  };
  k.Pp = function (a) {
    a = a.coords;
  ...
  k.Nb = function (a, b, c, d) {
    if (d < Ha(this.G(), a, b)) return d;
    this.o != this.g &&
      ((this.D = Math.sqrt(pf(this.A, 0, this.A.length, this.a, 0))), (this.o = this.g));
  ...
  function Xk(a) {
    ...
    1 == a.showLabels &&
      ((this.$ = void 0 == a.lonLabelFormatter ? Ce.bind(this, 'EW') : a.lonLabelFormatter),
  ...
  var Yk = new Ak({ color: 'rgba(0,0,0,0.2)' }),
    Zk = [90, 45, 30, 20, 10, 5, 2, 1, 0.5, 0.2, 0.1, 0.05, 0.01, 0.005, 0.002, 0.001];
  ...
  k.load = function () {
    3 == this.state &&
      ((this.state = 0), (this.M = new Image()), null !== this.f && (this.M.crossOrigin = this.f));
    0 == this.state &&
      ((this.state = 1),
      this.u(),
    ...
    for (f = this.o.length - 1; 0 <= f; --f) {
      ...
      for (g = this.o[f]; 0 <= h && this.g[h] >= g; ) {
        ...
        if (
          ...
          n.U() &&
          (void 0 === e || hb(e, n.U().G())) &&
          (a.clear(a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT), sl(a, b, m, l), (l = d(n)))
        )
          return l;
        h--;
        l = m;
    ...
    if (nb(c)) {
      ...
      for (f = g = 0, h = e.length; f < h; ++f) {
        ...
        for (var l = 0 < f ? d[f - 1] : 0, m = d[f], n = l; g < this.g.length && this.g[g] <= m; ) {
          ...
          void 0 !== c[p]
            ? (n !== l && sl(a, b, n, l), (l = n = g === this.g.length - 1 ? m : this.g[g + 1]))
    ...
    for (f = l.length - 1; 0 <= f; --f) {
      ...
      for (g = this.o[f]; 0 <= h && this.g[h] >= m; ) {
        ...
        if (
          ...
          p.U() &&
          (void 0 === e || hb(e, p.U().G())) &&
          (a.clear(a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT), sl(a, b, n, g), (g = d(p)))
        )
          return g;
        g = n;
        h--;
  ...
  k.vc = function (a, b) {
    ...
    this.b.length > c &&
      (this.g.push(c), this.i.push(b), this.c.u && (this.l.push(c), (this.c.u = !1)));
  };
  function gm(a, b, c, d) {
  ...
  function Hm(a, b, c) {
    ...
    3 === b.c &&
      ((e = a.b.length), (a.b[e++] = sm(b).Z.qb), (a.b[e++] = tm(b).Z.qb), (a.b[e++] = qm(b).Z.qb));
  }
      ...
      if (!1 === r.Kb) {
        ...
        (!d && 0 !== Fm({ Z: q, X: u }, c).length) ||
          ...
          (!d &&
            !1 !== q.Kb &&
            !1 !== u.Kb &&
            Mf([h.Z.x, h.Z.y, q.x, q.y, r.x, r.y, u.x, u.y, n.X.x, n.X.y], 0, 10, 2) !== !e) ||
          ((a.b[f++] = q.qb),
          (a.b[f++] = r.qb),
          (a.b[f++] = u.qb),
          Km(l, m, b, c),
  ...
  k.xc = function (a, b) {
    ...
    this.b.length > e &&
      (this.g.push(e), this.i.push(b), this.l.u && (this.c.push(e), (this.l.u = !1)));
      ...
      if (h.width >= b + this.b && h.height >= c + this.b)
        return (
          ...
          h.width - b > h.height - d
            ? ((c = { x: h.x + b, y: h.y, width: h.width - b, height: h.height }),
  ...
  function Wm(a, b, c, d, e, f, g) {
    ...
    for (l = h.length; m < l; ++m) {
      ...
      n ||
        m !== l - 1 ||
        (b ? ((n = Math.min(2 * a.c, a.g)), (a.c = n)) : ((n = Math.min(2 * a.a, a.g)), (a.a = n)),
        (n = new Rm(n, a.b)),
        h.push(n),
        ++l);
    }
  ...
  k.nb = function (a) {
    ...
    if (a && a.Ka() && (c || d)) {
      ...
      this.B[e] ||
        ...
        (this.B[e] = { Bh: new Tm({ space: b.lineWidth + 1 }), width: {}, height: a }));
      this.l = this.B[e];
    } else this.ta = '';
  };
  k.ig = function () {
  ...
  function on(a, b, c, d) {
    ...
    if (Tc(a, b)) {
      ...
      a.b(
        new bi(
          b,
          new gn(c, e.center, e.resolution, e.rotation, d.size, d.extent, d.pixelRatio),
          d,
          null,
          c
        )
  ...
  function vn(a, b, c) {
    ...
    if (Tc(d, b)) {
      ...
      d.b(
        new bi(
          b,
          new gn(a, e.center, e.resolution, e.rotation, c.size, c.extent, c.pixelRatio),
          c,
          null,
          a
        )
  ...
  k.bh = function (a) {
    ...
    if (this.b.width != e || this.b.height != f) (this.b.width = e), (this.b.height = f);
  ...
  function Bn(a) {
    ...
    this.element.className =
      void 0 !== a.className ? a.className : 'ol-overlay-container ol-selectable';
  ...
  function Sn(a) {
    a = a.frameState;
    a
      ? this.c != a.viewState.projection && ((this.c = a.viewState.projection), (this.j = null))
      : (this.c = null);
    Un(this, this.l);
  }
  k = Rn.prototype;
  ...
  k.setMap = function (a) {
    vg.prototype.setMap.call(this, a);
    a &&
      ((a = a.a), this.s.push(y(a, 'mousemove', this.mm, this), y(a, 'mouseout', this.nm, this)));
  };
  k.Gj = function (a) {
    this.set(Vn, a);
  };
  ...
  function Wn(a) {
    ...
    var h = (this.c = new G({ controls: new B(), interactions: new B(), view: a.view }));
    a.layers &&
  ...
  k.setMap = function (a) {
    var b = this.a;
    a !== b &&
      (b && ((b = b.aa()) && Mc(b, Xc('rotation'), this.Qe, this), this.c.Ad(null)),
      vg.prototype.setMap.call(this, a),
      a &&
        (this.c.Ad(this.C),
  ...
  k.Jn = function (a) {
    this.l !== a &&
      ((this.l = a), this.element.classList.toggle('ol-uncollapsible'), !a && this.j && $n(this));
  };
  k.In = function (a) {
  ...
  k.Xl = function (a) {
    ...
    a = ko(
      this,
      pa(
        1 === this.j ? (a.offsetX - this.O[0] / 2) / this.D : (a.offsetY - this.O[1] / 2) / this.v,
        0,
        1
      )
    );
  ...
  k.$l = function (a) {
    this.o ||
      ...
      (bg(this.a.aa(), 1, 1), (this.C = a.clientX), (this.B = a.clientY), (this.o = !0));
  };
  k.Yl = function (a) {
    if (this.o) {
  ...
  k.Wn = function (a, b, c) {
    return ('XYM' != this.ja && 'XYZM' != this.ja) || 0 === this.A.length
      ? null
      : Tk(this.A, this.c, this.a, a, void 0 !== b ? b : !1, void 0 !== c ? c : !1);
  };
  k.W = function () {
  ...
  k.na = function (a, b) {
    if (a) {
      ...
      0 === d.length
        ? (this.A.length = 0)
        : ((a = d[d.length - 1]), (this.A.length = 0 === a.length ? 0 : a[a.length - 1]));
      this.u();
  ...
  k.ld = function (a, b) {
    ...
    d &&
      ...
      b &&
        b.featureProjection &&
        (c.geometry.spatialReference = { wkid: Ob(b.featureProjection).wb.split(':').pop() }));
    b = a.L();
    delete b[a.a];
    c.attributes = nb(b) ? {} : b;
    return c;
  ...
  k.Kg = function (a, b) {
    ...
    for (a = a.firstElementChild; a; a = a.nextElementSibling) {
      ...
      if (
        ...
        (1 === a.childNodes.length && (3 === a.firstChild.nodeType || 4 === a.firstChild.nodeType))
      ) {
        var g = oo(a, !1);
        $o.test(g) && (g = void 0);
        d[f] = g;
  ...
  k.te = {
    'http://www.opengis.net/gml': { pos: vo(Kp.prototype.Yp), posList: vo(Kp.prototype.Pg) },
  };
  ...
  k.ek = {
    'http://www.opengis.net/gml': { LineString: uo(Zo.prototype.sf), Curve: uo(Kp.prototype.tj) },
  };
  k.sk = {
    'http://www.opengis.net/gml': { Polygon: uo(Zo.prototype.tf), Surface: uo(Kp.prototype.Bj) },
  };
  ...
  k.af = function (a, b, c) {
    ...
    'Polygon' === a.nodeName || 'PolygonPatch' === a.nodeName
      ? ((b = b.Ud()), Do({ node: a, hasZ: e, srsName: d }, Np, this.On, b, c, void 0, this))
      : 'Surface' === a.nodeName &&
  ...
  var Op = {
    ...
    Np = {
      'http://www.opengis.net/gml': { exterior: M(Kp.prototype.Ii), interior: M(Kp.prototype.Ii) },
    },
    Rp = {
      'http://www.opengis.net/gml': {
  ...
  k.Ze = function (a, b, c) {
    ...
    'PolygonPatch' !== a.nodeName && d && a.setAttribute('srsName', d);
    'Polygon' === a.nodeName || 'PolygonPatch' === a.nodeName
      ? ((b = b.Ud()), Do({ node: a, hasZ: e, srsName: d }, Yp, this.Kn, b, c, void 0, this))
      : 'Surface' === a.nodeName &&
        ((e = no(a.namespaceURI, 'patches')),
        a.appendChild(e),
        (a = no(e.namespaceURI, 'PolygonPatch')),
  ...
  var Lq = N(eq, {
    ...
    wpt: M(function (a, b, c) {
      var d = c[0],
        e = c[c.length - 1];
      e.properties = b.L();
      if ((b = b.U())) (b = Jo(b, !0, d)), (e.geometryLayout = b.ja), zq(a, b.W(), c);
    }),
  });
    ...
    for (m = d.length; n < m; ++n) {
      ...
      if ('B' == p.charAt(0)) {
        if ((q = Yq.exec(p))) {
          ...
          e.push(z, v);
          'none' != c &&
            e.push('gps' == c ? parseInt(q[11], 10) : 'barometric' == c ? parseInt(q[12], 10) : 0);
  ...
  function er(a) {
    ...
    fr ||
      ...
      (sr = new J({ font: 'bold 16px Helvetica', fill: hr, stroke: rr, scale: 0.8 })),
  ...
  function xr(a, b) {
    ...
    if (a.Y()) {
      ...
      null === e && (e = lr);
      2 == e.length &&
        ((d = a.Y().a), (c[0] = (d * e[0]) / 2), (c[1] = (-d * e[1]) / 2), (d = 'left'));
    }
    null !== a.Ka()
      ? ((e = a.Ka()),
        (a = e.clone()),
    ...
    ls = N(vr, {
      Pair: function (a, b) {
        if ((a = O({}, ks, a, b))) {
          ...
          c &&
            'normal' == c &&
            ((c = a.styleUrl) && (b[b.length - 1] = c), (a = a.Style) && (b[b.length - 1] = a));
        }
      },
    });
  k = er.prototype;
    ...
    for (c = b.firstElementChild; c; c = c.nextElementSibling)
      if (
        ...
        ec(vr, c.namespaceURI) &&
          ('Document' == b || 'Folder' == b || 'Placemark' == b || 'kml' == b) &&
          (b = ps(a, c)))
      )
        return b;
  }
  ...
  var Ps = N(vr, ['Document', 'Placemark']),
    ...
    Ts = N(vr, {
      Data: M(function (a, b, c) {
        ...
        b = b.value;
        'object' == typeof b
          ? (null !== b && b.displayName && Do(a, Ts, Ao, [b.displayName], c, ['displayName']),
    ...
    ft = N(vr, {
      IconStyle: M(function (a, b, c) {
        ...
        if (e) {
          ...
          !h ||
            (h[0] === e[0] / 2 && h[1] === e[1] / 2) ||
            (d.hotSpot = { x: h[0], oh: 'pixels', y: e[1] - h[1], ph: 'pixels' });
        }
        d.Icon = g;
        e = b.a;
        1 !== e && (d.scale = e);
  ...
  var qt = [null],
    ...
    tt = N(qt, {
      node: function (a, b) {
        ...
        a = O({ le: {} }, st, a, b);
        nb(a.le) ||
          ((f = new C(f)), Jo(f, !1, c), (c = new Hk(f)), c.qc(e), c.H(a.le), d.features.push(c));
      },
      way: function (a, b) {
        var c = a.getAttribute('id');
    ...
    'http://www.opengis.net/wfs': {
      ...
      Update: M(function (a, b, c) {
        ...
        if (void 0 !== e) {
          ...
          Do(
            { gmlVersion: d.gmlVersion, node: a, hasZ: d.hasZ, srsName: d.srsName },
            qu,
            yo('Property'),
            h,
            c
  ...
  k.Hp = function () {
    if (Vu(this, 2)) {
      var a;
      if (2 == this.b.type) for (a = [this.Hg()]; Vu(this, 5); ) a.push(this.Hg());
      else a = av(this);
      if (Vu(this, 3)) return a;
    } else if (Wu(this)) return [];
    throw Error(Xu(this));
  ...
  k.Nb = function (a, b, c, d) {
    ...
    if (b < d) {
      if (0 === b) for (d = 0; d < this.a; ++d) c[d] = e[d];
        ...
        for (
          d = this.Bd() / Math.sqrt(b), c[0] = e[0] + d * a, c[1] = e[1] + d * f, d = 2;
          d < this.a;
          ++d
        )
          c[d] = e[d];
  ...
  k.gj = function (a) {
    ...
    c
      ? ((c = c.G()),
        b in this.f ? (delete this.f[b], this.a && this.a.Ca(c, a)) : this.a && vm(this.a, c, a))
    ...
    a.s
      ? ((e = b.coordinate),
        ...
        c instanceof D && a.f !== Jw
          ? (a.C || (a.C = new Hk(new I(null))), (e = c.Wh(0)), (b = a.C.U()), b.ba(e.ja, e.da()))
          : a.T && ((b = a.C.U()), b.na(a.T)),
        Tw(a))
      : ((b = b.coordinate.slice()), a.B ? a.B.U().na(b) : ((a.B = new Hk(new C(b))), Tw(a)));
    return !0;
  }
  function Rw(a, b) {
    var c = !1;
    if (a.j) {
      ...
      a.f === Lw
        ? (d = a.a.length > a.Ea)
        : a.f === Jw && ((d = a.a[0].length > a.Ea), (e = [a.a[0][0], a.a[0][a.a[0].length - 2]]));
      if (d) {
        d = b.map;
    ...
    if (c) {
      ...
      for (var g = 0, h = e.length; g < h; ++g) {
        ...
        if ('Circle' === l.geometry.S() && 1 === l.index)
          ...
          if (
            ('LineString' !== l.geometry.S() && 'MultiLineString' !== l.geometry.S()) ||
            !f[n][0] ||
            0 !== f[n][0].index
          )
  ...
  function ix(a) {
    ...
    for (var b = 0, c = this.j.length; b < c; ++b) {
      ...
      switch (g.S()) {
        ...
        case 'Circle':
          (h[0] = h[1] = a),
            0 === e.index ? ((this.s = !0), g.ub(a)) : ((this.s = !0), g.fd(Ie(g.xa(), a))),
            (this.s = !1);
      }
    ...
    if (this.O && 'pointerdrag' != this.O.type) {
      ...
      for (h in c) {
        ...
        q &&
          ...
          void 0 !== m &&
            void 0 !== l &&
            ((m = { depth: g.depth, feature: g.feature, geometry: g.geometry, index: n, ma: d }),
            this.a.Ca(Ca(m.ma), m)),
      ...
      f.Tc(
        ...
        function (a, e) {
          if (this.l(a, e))
            return (
              (!b && !d) || ec(g.a, a)
                ? (c || d) && ec(g.a, a) && (h.push(a), (e = x(a)), delete this.a[e])
  ...
  k.setMap = function (a) {
    ...
    a &&
      (this.j
        ? c.push(y(this.j, 'add', this.Ni, this), y(this.j, 'remove', this.Oi, this))
        : this.s &&
          c.push(y(this.s, 'addfeature', this.Ni, this), y(this.s, 'removefeature', this.Oi, this)),
    ...
    if (this.l) {
      ...
      this.c.forEach(function (a) {
        if (Math.max(a.source[0][0], a.source[1][0], a.source[2][0]) - n > this.b / 2) {
          ...
          Math.max(b[0][0], b[1][0], b[2][0]) - Math.min(b[0][0], b[1][0], b[2][0]) < this.b / 2 &&
            (a.source = b);
        }
      }, this);
    }
  ...
  function hy(a, b, c, d, e, f, g, h, l, m, n) {
    ...
    if (0 === ab(f)) this.state = 4;
      ...
      ((this.f = b.Dc(d)),
      (c = gy(this.o)),
      e && (a.g ? ((c[1] = pa(c[1], e[1], e[3])), (c[3] = pa(c[3], e[1], e[3]))) : (c = gb(c, e))),
      ab(c))
    ) {
      a = tc(b, c, this.f);
      for (b = a.fa; b <= a.la; b++)
  ...
  function Li(a, b, c, d, e) {
    ...
    for (var f, g, h = d.fa; h <= d.la; ++h)
      for (var l = d.ea; l <= d.ka; ++l)
        (f = c + '/' + h + '/' + l),
          (g = !1),
          a.a.hasOwnProperty(f) && ((f = a.get(f)), (g = 2 === f.getState()) && (g = !1 !== e(f))),
          g || (b = !1);
    return b;
  }
  k.Zf = function () {
  ...
  function ky(a, b, c) {
    ...
    if (a.D && d.c) {
      ...
      Ja(d, a)
        ? (b = e)
        : ((e = cb(d)), (a[0] += e * Math.ceil((d[0] - a[0]) / e)), (b = c.jg(a, b)));
    }
    e = b[0];
    d = b[1];
    a = b[2];
  ...
  ry.prototype.La = function (a) {
    if (
      ...
      this.tileGrid = Bc({
        ...
        maxZoom: a,
        tileSize:
          (c.imageWidth == c.imageHeight ? c.imageWidth : [c.imageWidth, c.imageHeight]) /
          (this.i ? 2 : 1),
      });
      var e = this.o,
        f = this.i;
          ...
          c.imageryProviders.map(function (c) {
            for (var e = !1, f = c.coverageAreas, h = 0, l = f.length; h < l; ++h) {
              ...
              if (
                d >= m.zoomMin &&
                d <= m.zoomMax &&
                ((m = m.bbox), (m = jb([m[1], m[0], m[3], m[2]], g)), hb(m, a.extent))
              ) {
                e = !0;
                break;
              }
  ...
  function sy(a) {
    ...
    var b = void 0 !== a.projection ? a.projection : 'EPSG:3857',
      c =
        void 0 !== a.tileGrid
          ? a.tileGrid
          : Bc({ extent: Dc(b), maxZoom: a.maxZoom, minZoom: a.minZoom, tileSize: a.tileSize });
    ny.call(this, {
      attributions: a.attributions,
      cacheSize: a.cacheSize,
  ...
  function wy(a) {
    if (void 0 !== a.resolution) {
      a.features.length = 0;
      for (
        var b = Da(), c = a.distance * a.resolution, d = a.source.ee(), e = {}, f = 0, g = d.length;
        f < g;
        f++
      ) {
        var h = d[f];
        ...
        if (1 === e)
          ...
          for (var f = 4 * Math.ceil(a.inputs[0].data.length / 4 / e), g = 0; g < e; ++g) {
            ...
            this.we[g].postMessage(
              { buffers: z, meta: a.ii, imageOps: this.Jf, width: b, height: c },
              z
            );
          }
      }
  ...
  function Zy(a) {
    ...
    sy.call(this, {
      ...
      url:
        void 0 !== a.url
          ? a.url
          : 'https://stamen-tiles-{a-d}.a.ssl.fastly.net/' + a.layer + '/{z}/{x}/{y}.' + c.Ob,
      wrapX: a.wrapX,
    });
  }
  w(Zy, sy);
  ...
  k.al = function (a, b, c, d, e) {
    this.tileGrid
      ? ((b = this.tileGrid.Le(a, b)), iz(this.ad(b[0], b[1], b[2], 1, this.c), a, c, d, e))
      : !0 === e
      ? setTimeout(function () {
          c.call(d, null);
        }, 0)
      ...
      if (1 != e)
        switch (a.B) {
          case 'geoserver':
            c = (90 * e + 0.5) | 0;
            g.FORMAT_OPTIONS =
              'FORMAT_OPTIONS' in g ? g.FORMAT_OPTIONS + (';dpi:' + c) : 'dpi:' + c;
            break;
          case 'mapserver':
